...
function Bala (game, x, y, sprite){
    ...
    this.direction = function (){
        ...
        if (this.orientacion === 0){ dir.x = 0; dir.y = -1;}
        else if (this.orientacion === 1){dir.x = 1; dir.y = 0;}
        else if (this.orientacion === 2){dir.x = 0; dir.y = 1;}
        else if (this.orientacion === 3){dir.x = -1; dir.y = 0;}
        return dir;
    }
...
Bala.prototype.AsignaValores = function (v, o, d) {
    this.vel = v; this.orientacion = o; this.damage = d;
}
